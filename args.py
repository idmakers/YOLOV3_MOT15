...
### Some paths
train_file = './data/my_data/VOC2012/train.txt'  # The path of the training txt file.
val_file = './data/my_data/VOC2012/val.txt'  # The path of the validation txt file.
restore_path = './data/darknet_weights/yolov3.ckpt'  # The path of the weights to restore.
save_dir = 'D:/610821239/yolo3/YOLOv3_TensorFlow/checkpoint/'  # The directory of the weights to save.
